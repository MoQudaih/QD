...
const CTA = () => (
  <section id="contact" className="qd-section qd-bridge-receive"
    ...
    <div style={{ maxWidth:1100,margin:'0 auto',position:'relative',zIndex:2,width:'100%' }}>
      <div style={{ display:'grid',gridTemplateColumns:'1.2fr 1fr',gap:60,alignItems:'center' }}>
        ...
        <Reveal delay={300} lift={48} duration={1100}>
          <div style={{ background:'var(--obsidian)',borderRadius:12,padding:20,color:'var(--fg1)',boxShadow:'0 24px 60px rgba(11,11,12,0.4)',transform:'rotate(1.5deg)' }}>
