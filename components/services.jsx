...
const Services = () => (
  <section id="services" className="qd-section" data-bridge="obsidian-2"
    ...
    <div style={{ maxWidth:1280,margin:'0 auto',position:'relative' }}>
      <div style={{ display:'grid',gridTemplateColumns:'1.2fr 1fr',gap:60,alignItems:'flex-end',marginBottom:64 }}>
        <Reveal lift={32}>
        ...
        <div style={{ textAlign:'right' }}><SectionLetter letter="Q" /></div>
      </div>

      <div style={{ display:'grid',gridTemplateColumns:'1.3fr 1fr',gap:16,marginBottom:16 }}>
        <Reveal lift={40} duration={900}>
          <div className="qd-lift" style={{ background:'var(--obsidian-3)',border:'1px solid var(--border-1)',borderRadius:16,padding:32,minHeight:480,display:'flex',flexDirection:'column',gap:20,boxShadow:'0 4px 24px rgba(0,0,0,0.4),inset 0 1px 0 rgba(244,241,234,0.06)' }}>
        ...
        <div style={{ display:'flex',flexDirection:'column',gap:16 }}>
          {[
            ...
            <Reveal key={i} delay={(i+1)*120} lift={40} duration={900}>
              <div className="qd-lift" style={{ background:'var(--obsidian-3)',border:'1px solid var(--border-1)',borderRadius:16,padding:24,display:'grid',gridTemplateColumns:'1fr 1fr',gap:16,alignItems:'center',minHeight:232 }}>
      ...
      <Reveal delay={120} lift={40} duration={900}>
        <div className="qd-lift" style={{ background:'var(--obsidian-3)',border:'1px solid var(--border-1)',borderRadius:16,padding:32,display:'grid',gridTemplateColumns:'1fr 1fr',gap:32,alignItems:'center',minHeight:240 }}>
