...
const Problem = ({ language = 'en' }) => {
  ...
  return (
    <section ref={sectionRef} className="qd-section" data-bridge="obsidian-2"
      ...
      <div style={{ position:'absolute',inset:0,pointerEvents:'none',background:'radial-gradient(circle at 16% 18%, rgba(166,240,79,0.07), transparent 24%), radial-gradient(circle at 82% 76%, rgba(166,240,79,0.06), transparent 22%), linear-gradient(180deg, rgba(12,13,15,0.92), rgba(10,11,13,1))' }} />
      ...
      <div style={{ position:'absolute',top:-220,left:'5%',width:'clamp(170px,18vw,300px)',height:'150%',transform:`rotate(-11deg) translateY(${sp*-54}px)`,background:'linear-gradient(180deg,rgba(166,240,79,0.16) 0%,rgba(166,240,79,0.07) 28%,rgba(166,240,79,0.015) 58%,rgba(166,240,79,0) 82%)',filter:'blur(1px)',pointerEvents:'none' }} />
      <div style={{ position:'absolute',top:-220,left:'5%',width:3,height:'150%',transform:`rotate(-11deg) translateY(${sp*-76}px)`,background:'linear-gradient(180deg,rgba(166,240,79,0.46) 0%,rgba(166,240,79,0.18) 42%,rgba(166,240,79,0) 78%)',boxShadow:'0 0 24px rgba(166,240,79,0.22)',pointerEvents:'none' }} />
      <div style={{ position:'absolute',right:'8%',top:'16%',width:'clamp(220px,26vw,420px)',height:'clamp(220px,26vw,420px)',border:'1px solid rgba(166,240,79,0.08)',borderRadius:'50%',transform:`translateY(${sp*40}px)`,pointerEvents:'none' }} />
      <div style={{ position:'absolute',right:'13%',top:'25%',width:'clamp(140px,17vw,280px)',height:'clamp(140px,17vw,280px)',border:'1px solid rgba(166,240,79,0.06)',borderRadius:'50%',transform:`translateY(${sp*64}px)`,pointerEvents:'none' }} />
      <div style={{ position:'absolute',right:'6%',bottom:'10%',fontFamily:'var(--font-display)',fontSize:'clamp(180px,22vw,340px)',fontWeight:700,letterSpacing:'-0.08em',lineHeight:0.82,color:'transparent',WebkitTextStroke:'1px rgba(166,240,79,0.06)',opacity:0.55,transform:`translateY(${sp*34}px)`,pointerEvents:'none',userSelect:'none' }}>QD</div>
      <div style={{ position:'absolute',right:'18%',top:'57%',width:120,height:1,background:'linear-gradient(90deg, transparent, rgba(166,240,79,0.38), transparent)',transform:`translateY(${sp*46}px)`,pointerEvents:'none' }} />
      <div style={{ position:'absolute',right:'18%',top:'57%',width:8,height:8,borderRadius:'50%',border:'1px solid rgba(166,240,79,0.5)',background:'rgba(166,240,79,0.12)',boxShadow:'0 0 18px rgba(166,240,79,0.18)',transform:`translateY(${sp*46}px) translateX(52px)`,pointerEvents:'none' }} />
